...
var shapeS = "";
var pshape = 1; // Which shape is picked(1=ellipse,2=rect,3=line)
...
var draw = function() {
	...
	line(0, 315, width, 315); // Bottom line that seperates picture from control center
	changeShape.draw();
